...
def generate_model(params):
    ...
    i1 = Concatenate(axis=1)([SeqWeightedAttention()(i1),GlobalMaxPooling1D()(i1), GlobalAveragePooling1D()(i1)])
    i2 = Conv1D(params['embedding_dim']*2, 3, activation='relu')(input_layer)
    i2 = Concatenate(axis=1)([SeqWeightedAttention()(i2),GlobalMaxPooling1D()(i2), GlobalAveragePooling1D()(i2)])
    i3 = Conv1D(params['embedding_dim']*2, 4, activation='relu')(input_layer)
    i3 = Concatenate(axis=1)([SeqWeightedAttention()(i3),GlobalMaxPooling1D()(i3), GlobalAveragePooling1D()(i3)])
