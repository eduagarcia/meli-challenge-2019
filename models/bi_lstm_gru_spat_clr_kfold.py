...
from attention import SeqWeightedAttention
from util import CyclicLR
from sklearn.model_selection import StratifiedKFold
import keras.backend as K

NAME = "bi_lstm_gru_spat_clr_kfold"
...
def generate_model(params):
    ...
    i1 = Concatenate(axis=1)([SeqWeightedAttention()(i1), GlobalAveragePooling1D()(i1), GlobalMaxPooling1D()(i1)])
    i2 = Bidirectional(CuDNNGRU(params['embedding_dim'], return_sequences=True))(input_layer)
    i2 = Concatenate(axis=1)([SeqWeightedAttention()(i2), GlobalAveragePooling1D()(i2), GlobalMaxPooling1D()(i2)])
